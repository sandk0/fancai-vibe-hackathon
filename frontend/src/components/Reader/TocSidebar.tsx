          ...
          >
              ...
              <div className="relative">
                ...
                {searchQuery && (
                  <motion.button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded-full text-[var(--color-text-subtle)] hover:text-[var(--color-text-default)] hover:bg-[var(--color-bg-muted)] transition-colors"
            ...
            >
              {filteredToc.length === 0 ? (
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-[var(--color-bg-emphasis)] flex items-center justify-center mb-4">
