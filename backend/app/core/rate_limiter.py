    ...
    async def can_start_parsing(
        ...
        try:
            ...
            if active_count >= self.max_concurrent:
                return False, f"System at capacity ({active_count}/{self.max_concurrent} tasks)"
            ...
            if user_count >= self.max_per_user:
                return False, f"User limit reached ({user_count}/{self.max_per_user} tasks)"
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'capacity_percent': (active_count / self.max_concurrent * 100) if self.max_concurrent > 0 else 0
            }
    ...
    async def _check_system_resources(self) -> tuple[bool, str]:
        ...
        try:
            ...
            if memory.available < 2 * 1024 * 1024 * 1024:  # Less than 2GB available
                return False, f"Insufficient memory: {memory.available / 1024 / 1024 / 1024:.1f}GB available"
