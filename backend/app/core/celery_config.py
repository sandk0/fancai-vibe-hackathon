...
CELERY_CONFIG = {
    ...
    'worker_concurrency': int(os.getenv('CELERY_CONCURRENCY', '3')),  # Reduced from 5
    'worker_prefetch_multiplier': 1,  # One task at a time
    'worker_max_tasks_per_child': 50,  # Restart after 50 tasks to prevent memory leaks
    'worker_max_memory_per_child': 1800000,  # 1.8GB max per worker
...
RESOURCE_LIMITS = {
    'max_concurrent_heavy_tasks': 3,  # Max 3 book parsings simultaneously
