...
1. ОБЯЗАТЕЛЬНО извлекай ТОЛЬКО ПОЛНЫЕ ПРЕДЛОЖЕНИЯ - от заглавной буквы до знака препинания (. ! ? ... ; :)
2. НИКОГДА не обрезай предложения посередине - не начинай со строчной буквы, не заканчивай на середине слова
3. Сохраняй ОРИГИНАЛЬНЫЙ текст автора БЕЗ ИЗМЕНЕНИЙ - копируй точно как в тексте
4. Минимум 200 символов на описание, максимум 2000 символов
5. НЕ извлекай диалоги (текст в кавычках), внутренние мысли, действия без визуальных деталей
6. Каждое описание должно быть самодостаточным для создания изображения
7. confidence: 0.9+ для ярких детальных описаний, 0.7-0.9 для средних, 0.5-0.7 для базовых

ПРАВИЛА ГРАНИЦ ПРЕДЛОЖЕНИЙ:
- Начало: после точки, восклицательного знака, вопросительного знака, многоточия, двоеточия, точки с запятой, начала абзаца
- Конец: точка, восклицательный знак, вопросительный знак, многоточие (до следующего предложения)
- ЗАПРЕЩЕНО: начинать с "и", "а", "но" если это продолжение предыдущего предложения
- ЗАПРЕЩЕНО: заканчивать на запятой или посередине слова
...
Правильно: "Старый замок возвышался на высоком холме, окруженный густым лесом. Его величественные башни касались низких облаков, а мрачные стены хранили множество тайн."
НЕПРАВИЛЬНО: "замок возвышался на высоком холме, окруженный густым лесом. Его величественные башни"

Текст: "Князь был высок и строен. Длинные чёрные волосы обрамляли бледное лицо с пронзительными серыми глазами."
Правильно: "Князь был высок и строен. Длинные чёрные волосы обрамляли бледное лицо с пронзительными серыми глазами."
НЕПРАВИЛЬНО: "строен. Длинные чёрные волосы обрамляли бледное"
...
ОТВЕТ (только JSON, каждое описание - полные предложения):"""
