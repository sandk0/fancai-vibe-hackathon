...
class AdvancedParserConfig:
    ...
    length_priority_zones: Dict[str, LengthPriorityZone] = field(default_factory=lambda: {
    ...
    chapter_markers: List[str] = field(default_factory=lambda: [
        'ГЛАВА',
        'Глава',
        'ЧАСТЬ',
        'Часть',
    ...
    continuation_signals: List[str] = field(default_factory=lambda: [
        # Местоименные ссылки
        'Он', 'Она', 'Оно', 'Они',
        'Его', 'Её', 'Их',
        'Этот', 'Эта', 'Это', 'Эти',
    ...
    stop_signals: List[str] = field(default_factory=lambda: [
        # Временные маркеры (начало нового действия)
        'Вдруг', 'Внезапно', 'Затем', 'Потом', 'После',
        'Через', 'Спустя',
        # Действия персонажей
    ...
    min_factor_scores: Dict[str, float] = field(default_factory=lambda: {
    ...
    visual_keywords: Dict[str, List[str]] = field(default_factory=lambda: {
        "colors": [
        ...
        "shapes": [
            ...
            "острый", "тупой", "изогнутый", "прямой", "волнистый",
        ],
        "materials": [
    ...
    type_indicators: Dict[str, List[str]] = field(default_factory=lambda: {
        "location": [
            # Места и пространства
            "место", "локация", "город", "деревня", "замок", "дом", "здание",
            "комната", "зал", "улица", "площадь", "парк", "лес", "гора",
            "река", "озеро", "море", "побережье", "остров", "долина",
            # Предлоги места
            "в", "на", "под", "над", "возле", "около", "рядом", "вокруг",
            # Пространственные характеристики
            "простирался", "возвышался", "находился", "располагался",
        ],
        "character": [
            # Внешность
            ...
            # Внешний вид
            "выглядел", "выглядела", "казался", "казалась", "был одет",
            "была одета", "носил", "носила",
        ],
        "atmosphere": [
            # Настроение и чувства
            "атмосфера", "настроение", "ощущение", "чувство", "дух",
            "аура", "впечатление", "эмоция",
            # Описательные прилагательные
            "мрачный", "веселый", "тревожный", "спокойный", "напряженный",
            "торжественный", "таинственный", "зловещий", "радостный",
    ...
    antipatterns: Dict[str, List[str]] = field(default_factory=lambda: {
        "dialog_fragments": [
